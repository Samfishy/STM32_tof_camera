...
C_DEPS += \
./grapics/examples/libs/sjpg/lv_example_sjpg_1.d 


# Each subdirectory must supply rules for building sources it contributes
grapics/examples/libs/sjpg/%.o grapics/examples/libs/sjpg/%.su grapics/examples/libs/sjpg/%.cyclo: ../grapics/examples/libs/sjpg/%.c grapics/examples/libs/sjpg/subdir.mk
...
clean: clean-grapics-2f-examples-2f-libs-2f-sjpg

clean-grapics-2f-examples-2f-libs-2f-sjpg:
	-$(RM) ./grapics/examples/libs/sjpg/lv_example_sjpg_1.cyclo ./grapics/examples/libs/sjpg/lv_example_sjpg_1.d ./grapics/examples/libs/sjpg/lv_example_sjpg_1.o ./grapics/examples/libs/sjpg/lv_example_sjpg_1.su

.PHONY: clean-grapics-2f-examples-2f-libs-2f-sjpg
