...
C_DEPS += \
./grapics/examples/libs/qrcode/lv_example_qrcode_1.d 


# Each subdirectory must supply rules for building sources it contributes
grapics/examples/libs/qrcode/%.o grapics/examples/libs/qrcode/%.su grapics/examples/libs/qrcode/%.cyclo: ../grapics/examples/libs/qrcode/%.c grapics/examples/libs/qrcode/subdir.mk
...
clean: clean-grapics-2f-examples-2f-libs-2f-qrcode

clean-grapics-2f-examples-2f-libs-2f-qrcode:
	-$(RM) ./grapics/examples/libs/qrcode/lv_example_qrcode_1.cyclo ./grapics/examples/libs/qrcode/lv_example_qrcode_1.d ./grapics/examples/libs/qrcode/lv_example_qrcode_1.o ./grapics/examples/libs/qrcode/lv_example_qrcode_1.su

.PHONY: clean-grapics-2f-examples-2f-libs-2f-qrcode
